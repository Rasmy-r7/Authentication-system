        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            ...
            <input
              ...
              type="email" className='bg-transparent outline-none ' placeholder='Email id' required />
          </div>
          ...
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            ...
            <input
              ...
              type="password" className='bg-transparent outline-none ' placeholder='Password ' required />
          </div>
